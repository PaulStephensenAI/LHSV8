...
import { CompanionGreetingCard } from './components/CompanionGreetingCard';
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 lg:px-8 py-6 space-y-8">
        ...
        {activeViewSection === 'workspace' && (
          <div className="animate-in fade-in duration-200 space-y-8">
            ...
            {/* THE MASTER HERO CARD (With Interactive Quick Summary Hover States on Companion Avatars) */}
            <MasterHeroCard
              activeCompanionId={activeCompanionId}
              onSelectCompanion={handleSelectCompanion}
              onOpenChat={handleOpenChat}
            ...
            {/* Dynamic Companion Greeting & Affirmation Card */}
